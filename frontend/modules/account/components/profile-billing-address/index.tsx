...
import NativeSelect from "@/components/store-front/native-select";
...
const ProfileBillingAddress: React.FC<MyInformationProps> = ({
  ...
  const currentInfo = useMemo(() => {
    ...
    return (
      <div className={styles.currentInfo} data-testid="current-info">
        <span>
    ...
    >
      ...
      >
        <div className={styles.inputGrid}>
          ...
          />
          <div className={styles.postalCodeGrid}>
            <Input
              label="Postal code"
              name="postal_code"
